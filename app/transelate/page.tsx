...
export default function Page() {
    ...
    // ==== レンダリング ====
    return (
        <main className={isZenn ? 'max-w-4xl w-11/12 mx-auto pt-3 md:pt-8' : 'max-w-4xl w-11/12 mx-auto pt-8 md:pt-14'}>
            ...
            <form className={isZenn ? 'relative mt-0' : 'relative mt-8'} onSubmit={submitClick}>
                ...
                <div className="flex flex-col">
                    <div
                        ...
                        className={
                            isZenn
                                ? 'absolute right-0 top-[-20px] py-1 px-2 bg-blue-800 text-white rounded-md duration-300 hover:bg-blue-600 hover:cursor-pointer'
                                : 'absolute right-0 top-1 py-1 px-2 bg-blue-800 text-white rounded-md duration-300 hover:bg-blue-600 hover:cursor-pointer'
                        }
                    >
                        Zenn
                    </div>
